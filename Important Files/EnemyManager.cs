...
namespace CompleteProject
{
    public class EnemyManager : MonoBehaviour
    {
        ...
        void SpawnBunny()
        {
            tempClone = Instantiate(enemyBunnySpawn, spawnPoints[0].position, spawnPoints[0].rotation);
            tempClone.tag = "clone";
            Debug.Log("Spawned Bunny");
        }
        void SpawnBear()
        {
            tempClone = Instantiate(enemyBearSpawn, spawnPoints[1].position, spawnPoints[1].rotation);
            tempClone.tag = "clone";
            Debug.Log("Spawned Bear");
        }
        void SpawnBunny2()
        {
            tempClone = Instantiate(enemyBunny2Spawn, spawnPoints[2].position, spawnPoints[2].rotation);
            tempClone.tag = "clone";
            Debug.Log("Spawned Bunny2");
        }       
        void SpawnElephant()
        {
            tempClone = Instantiate(enemyElephantSpawn, spawnPoints[3].position, spawnPoints[3].rotation);
            tempClone.tag = "clone";
